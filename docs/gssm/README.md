...
Welcome to the GFN framework documentation. GFN (Geometric Flow Networks) is a physics-informed paradigm for sequential intelligence that reformulates sequence modeling through the lens of differential geometry and Hamiltonian mechanics.

## Documentation Structure

### Paradigm Documentation

- [Theoretical Foundations](../THEORY.md) - Complete paradigm theory and mathematical foundations
- [Architecture Registry](../ARCHITECTURES.md) - Available GFN realizations and their characteristics
- [Contributing Guide](../CONTRIBUTING.md) - Standards for adding new realizations

### G-SSM Realization

The Geodesic State Space Model (G-SSM) is a differential realization of the GFN paradigm.
...
- [Archive Structure](guides/01-introduction/03-archive-structure.md) - Project organization
...
- [Research Papers](00_papers/) - Theoretical research and extensions

## Key Features

- **O(1) Inference Memory**: Constant memory regardless of sequence length (G-SSM realization)
...
- [GFN Paradigm Paper](../GEOMETRY_IS_ALL_YOU_NEED.tex)

"""
GFN Realizations API Router (Unified Core Version)
==================================================
...
def get_realizations() -> List[str]:
    return list_available()

# Dynamic metadata (evaluated at import time could be stale if register is called later, 
# but for basic usage it's fine or we use a property/method)
REALIZATIONS = list_available()

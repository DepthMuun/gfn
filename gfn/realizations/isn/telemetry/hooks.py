...
class ISNHook:
    ...
    def before_scanner(self, token_ids: torch.Tensor): pass
    def after_scanner(self, impulses: torch.Tensor): pass
    def before_world(self, world_input: Dict[str, Any]): pass
    def after_world(self, world_output: Dict[str, Any]): pass
    def on_emission(self, step: int, token_id: int, energy: float): pass

"""
Test Results Reporter — GFN GSSM (Benchmark Version)
=====================================================

Handles saving test results to JSON format for analysis.
Generates reports in tests/results/benchmarks/ directory.
"""
...
class ResultsReporter:
    ...
    def __init__(self, test_name: str, category: str = "benchmarks"):
        ...
        # Results directory - goes up 3 levels from benchmarks/ to reach tests/
        # benchmarks/ -> gssm/ -> tests/
        self.results_dir = Path(__file__).resolve().parent.parent.parent / "results" / category
        self.results_dir.mkdir(parents=True, exist_ok=True)
        
        # Also create category results dir within each test area
        self.category_results_dir = Path(__file__).resolve().parent / "results"

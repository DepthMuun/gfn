"""
Test Results Reporter — GFN GSSM (Research Version)
==================================================

Handles saving test results to JSON format for analysis.
Generates reports in tests/results/research/ directory.
"""
...
class ResultsReporter:
    ...
    def __init__(self, test_name: str, category: str = "research"):
        ...
        # Results directory - goes up 3 levels from research/ to reach tests/
        # research/ -> gssm/ -> tests/
